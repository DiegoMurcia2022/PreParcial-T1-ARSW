...
public class ProcessTransactionDataThread extends Thread {
    ...
    public ProcessTransactionDataThread(List<File> transactionFiles, int a, int b, TransactionAnalyzer transactionAnalyzer, AtomicInteger amountOfFilesProcessed, TransactionReader transactionReader) {
